...
```powershell
 wsl hostname -I
```
![[assets/Pasted image 20240306200159.png|200]]
...
```
*all in device driver menu*
2. These are the necessary additional features in `menuconfig`.
```text
...
![[assets/Pasted image 20240306115828.png]]
...
```
![[assets/Pasted image 20240306121432.png]]
...
```
![[assets/Pasted image 20240306122129.png|400]]
...
guvcview
```
![[assets/Pasted image 20240306142902.png]]
