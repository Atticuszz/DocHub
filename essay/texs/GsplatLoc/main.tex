...
\begin{table}[htbp]
\centering
\begin{tabularx}{1.0\textwidth}{lXXXXXXXXX}
\toprule
Methods & Avg. & R0 & R1 & R2 & Of0 & Of1 & Of2 & Of3 & Of4\\
\midrule
ICP & \cellcolor{lime!50}0.38 & \cellcolor{lime!50}0.53 & \cellcolor{yellow!30}0.38 & 0.45 & \cellcolor{green!30}\textbf{0.35} & \cellcolor{green!30}\textbf{0.24} & \cellcolor{lime!50}0.36 & \cellcolor{lime!50}0.33 & \cellcolor{green!30}\textbf{0.43}\\
...
Point-SLAM & 0.52 & 0.61 & 0.41 & \cellcolor{yellow!30}0.37 & \cellcolor{yellow!30}0.38 & \cellcolor{lime!50}0.48 & 0.54 & 0.69 & 0.72\\
SplaTAM & \cellcolor{yellow!30}0.36 & \cellcolor{yellow!30}0.31 & \cellcolor{lime!50}0.40 & \cellcolor{green!30}\textbf{0.29} & \cellcolor{lime!50}0.47 & \cellcolor{yellow!30}0.27 & \cellcolor{yellow!30}0.29 & \cellcolor{yellow!30}0.32 & \cellcolor{lime!50}0.55\\
\midrule
\textbf{Ours} & \cellcolor{green!30}\textbf{0.10} & \cellcolor{green!30}\textbf{0.20} & \cellcolor{green!30}\textbf{0.30} & \cellcolor{lime!50}0.40 & 0.50 & 0.60 & \cellcolor{green!30}\textbf{0.20} & \cellcolor{green!30}\textbf{0.30} & \cellcolor{yellow!30}0.50\\
\bottomrule
\end{tabularx}
\caption{Replica[4] (ATE RMSE ↓[cm])}
\label{table:}
\end{table}
...
operator {[}6{]}, which effectively captures depth discontinuities and
...
{[}5{]}. The poses for TUM-RGBD were captured using an external motion
capture system.
...
\midrule
Kintinous & \cellcolor{yellow!30}4.84 & 3.70 & 7.10 & \cellcolor{yellow!30}7.50 & 2.90 & \cellcolor{lime!50}3.00\\
ElasticFusion & 6.91 & \cellcolor{yellow!30}2.53 & 6.83 & 21.49 & \cellcolor{yellow!30}1.17 & \cellcolor{yellow!30}2.52\\
ORB-SLAM2 & \cellcolor{green!30}\textbf{1.98} & \cellcolor{green!30}\textbf{1.60} & \cellcolor{green!30}\textbf{2.20} & \cellcolor{green!30}\textbf{4.70} & \cellcolor{green!30}\textbf{0.40} & \cellcolor{green!30}\textbf{1.00}\\
NICE-SLAM & 15.87 & 4.26 & \cellcolor{lime!50}4.99 & 34.49 & 31.73 & 3.87\\
Vox-Fusion & 11.31 & 3.52 & 6.00 & 19.53 & 1.49 & 26.01\\
Point-SLAM & 8.92 & 4.34 & \cellcolor{yellow!30}4.54 & 30.92 & 1.31 & 3.48\\
\midrule
\textbf{SplaTAM} & \cellcolor{lime!50}5.48 & \cellcolor{lime!50}3.35 & 6.54 & \cellcolor{lime!50}11.13 & \cellcolor{lime!50}1.24 & 5.16\\
\bottomrule
\end{tabularx}
\caption{TUM[5] (ATE RMSE ↓[cm])}
\label{table:}
\end{table}
