...
var j = class extends h.Component {
  ...
  addChild(e) {
    return (
      this.children.has(e) ||
        (this.children.add(e),
        this.loaded ? M(() => super.addChild(e)) : super.addChild(e)),
      e
    );
  }
};
...
var q = class extends h.Component {
  ...
  ne = class extends L {
      ...
      this.registerEvent(
        app.workspace.on("layout-change", () => {
          app.workspace.layoutReady &&
            ...
            (this.layoutReadyCallbacks.forEach(M),
            (this.layoutReadyCallbacks = []));
        }),
      ),
    ...
    onLayoutReady(e) {
      app.workspace.layoutReady ? M(e) : this.layoutReadyCallbacks.push(e);
    }
    onunload() {
      var e, t;
...
function Me(r, i = r.constructor.prototype) {
...
function Ae(r, i, e) {
  ...
  for (i.__redom_mounted && G(i, "onunmount"); o; ) {
    ...
    Ce(n) && (o.__redom_lifecycle = null), (o = o.parentNode);
  }
}
function Ce(r) {
  if (r == null) return !0;
...
_.prototype.update = function (i, e) {
  ...
  if (o)
    for (var u = 0; u < n.length; u++) {
      var p = n[u],
        m = p.__redom_id;
      l[m] == null && ((p.__redom_index = null), C(this, p));
    }
...
lt.prototype.update = function (i, e) {
  ...
  if (i) {
    if (!this.visible)
      if (this._el)
        T(o, this._el, t), C(o, t), (this.el = w(this._el)), (this.visible = i);
      else {
        var n = this._View,
          s = new n(this._initData);
        (this.el = w(s)), (this.view = s), T(o, s, t), C(o, t);
      }
    this.view && this.view.update && this.view.update(e);
  } else if (this.visible) {
    if (this._el) {
      T(o, t, this._el), C(o, this._el), (this.el = t), (this.visible = i);
      return;
    }
    T(o, t, this.view), C(o, this.view), (this.el = t), (this.view = null);
  }
  this.visible = i;
};
  ...
  F = class extends c.Menu {
    ...
    cascade(e, t, o, n = 15, s = 5) {
      ...
      let { left: a, top: l, bottom: u, width: p } = e.getBoundingClientRect(),
        m = Math.max(
          0,
          a + (e.matchParent(".menu") ? Math.min(150, p / 3) : 0),
        ),
...
var x = !0,
  P = class extends F {
    ...
    loadFiles(e, t) {
      this.items.forEach((a) => a.dom.detach()), (this.items = []);
...
var me = class {
  ...
  I = class extends q {
    ...
    onload() {
      ...
      if ((this.register(() => C(e, this)), T(e, this), this.isCurrent()))
